...
from matplotlib.backend_bases import PickEvent, NavigationToolbar2
import matplotlib
import numpy as np
...
class MplWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.snap_cursor_a = QAction(QIcon('cross.png'), 'Enable cross hair cursor \nClick any line to snap to it')
